...
<div class="row">
		...
		<div class="col-lg-12 col-md-12 col-sm-12" id="errormessage" style="color: red;font-weight: bold;font-size: 15px;"><?php if(!empty($_GET['errormessage'])) {echo $errormessage = $_GET['errormessage'];} ?><?php if(!empty($_SESSION['error'])) {echo $_SESSION['error'];} ?></div>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 text-right"><h5><a href="<?php echo "add_gallery_image.php?plant_id=$id&&plant_name=$plant_name"; ?>">Add Gallery Image for <?php echo $plant_name; ?></a></h5></div>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100"><?php $group_image= DIR_UPLOAD_GROUP.$data_pg['group_image']; ?>
